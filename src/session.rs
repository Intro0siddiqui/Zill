...
impl ZillSession {
    ...
    /// Executes an AST node recursively.
    fn execute_node(
        &mut self,
        node: &AstNode,
    ...
    /// Expands shell variables ($VAR or ${VAR}) in the given string.
    ...
    /// Dispatches a command name to its corresponding builtin implementation.
    fn execute_builtin(
        &mut self,
        name: &str,
        args: &[String],
